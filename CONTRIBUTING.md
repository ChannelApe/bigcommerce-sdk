# Contributing
Thanks for taking the time to contribute to the BigcommerceSDK project!
...
- Verify that a bug for this doesn't already exist [here](https://github.com/ChannelApe/bigcommerce-sdk/issues).
...
- Verify that a feature request doesn't already exist [here](https://github.com/ChannelApe/bigcommerce-sdk/issues).
- Use a clear descriptive title.
